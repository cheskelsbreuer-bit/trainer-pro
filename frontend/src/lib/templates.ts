...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    description:
      'Built for dojos, BJJ academies, karate, and boxing gyms. Tracks belt/rank progression per student, runs recurring class schedules, handles family memberships.',
    bestFor: [
      'BJJ / karate / judo / TKD',
    ...
    matchSpecialties: ['martial_arts', 'boxing_kickboxing', 'group_classes'],
    matchKeywords: [
      'martial',
      'karate',
      'bjj',
