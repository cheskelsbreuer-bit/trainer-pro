...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    emoji: '🌀',
    tagline: 'Multi-instructor studio with a weekly class schedule, packs & memberships.',
    description:
      'For commercial group-class studios: yoga, spin, HIIT, pilates, barre, CrossFit, dance. Weekly recurring schedule across multiple class types and instructors. Members buy class packs or unlimited monthly memberships and reserve a spot in each class. Waitlists, attendance, instructor pay reports.',
    bestFor: [
      'Multiple class types per week (yoga + spin + HIIT…)',
      'Multiple instructors on payroll',
      'Class packs OR unlimited monthly memberships',
      'Clients book a spot in advance — capacity matters',
      'A schedule that repeats every week',
    ],
    matchSpecialties: ['group_classes', 'general_fitness', 'strength'],
    matchKeywords: [
      'yoga studio',
      'spin studio',
      'crossfit',
    ...
    defaults: {
      packages: [
        { name: 'Drop-in', sessions: 1, price: 25 },
        { name: '10-class pack', sessions: 10, price: 200 },
        { name: 'Unlimited monthly', sessions: 0, price: 159 },
      ],
      booking_settings: { default_duration_min: 60, lead_hours: 2, buffer_min: 0 },
      booking_enabled: true,
    },
  ...
  {
    slug: 'exercise_group',
    name: 'Solo instructor — pay-per-class group',
    emoji: '💪',
    tagline: 'One instructor, the same ~50 women, weekly classes, per-class billing.',
    description:
      'For the single instructor running their OWN small recurring exercise group — typically a women\'s class, 1-2 days a week, with ~30-100 regulars who pay per class. Tracks running balances, who-owes-money, paused/returned, payment history. NOT for commercial studios — pick "Group fitness studio" instead.',
    bestFor: [
      'Solo instructor running their own class',
      'Per-class billing (NOT monthly membership)',
      'Recurring weekly groups by day of week',
      'Same ~30-100 regulars every week',
      'Family-discount aware',
    ],
    matchSpecialties: ['group_classes'],
    matchKeywords: [
      'pay-per-class',
      'instructor',
      'women\'s exercise',
